package grassland.xmpp {
	...
	import grassland.xmpp.XMPPChannel;
	...
	public class XMPPDataPaster extends EventDispatcher {
		...
		private function onConnect(e:ChannelStateEvent):void{
			...
			dispatchEvent(e);
			_channel.sendData("<stream:stream to='dormforce.net' xmlns='jabber:client' xmlns:stream='http://etherx.jabber.org/streams' version='1.0'>")
		}
